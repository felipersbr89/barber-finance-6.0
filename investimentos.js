...
const InvestimentosModule = (() => {
  ...
  async function salvar() {
    ...
    if(!nome||!tipo||!inst||!vi||!va||!dataVal){Toast.err('Preencha todos os campos obrigatórios.');return}
  ...
  async function salvarEdicao() {
    ...
    if(!nome||!tipo||!inst||!vi||!va||!dataVal){Toast.err('Preencha os campos.');return}
    Utils.setLoading(btn,true,'Salvando...')
